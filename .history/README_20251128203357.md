...
Pretrained word vector: [This Link](https://pan.baidu.com/s/1Rn7LtTH0n7SHyHPfjRHbkg)

unzip and put it in ./app/routes/src
...
- 搜索功能现在在demo中能正常使用
- 完成了搜索功能，现在能够框选搜索，查询方式为模糊查询，支持查询name, type和district字段
- 添加了语义查询